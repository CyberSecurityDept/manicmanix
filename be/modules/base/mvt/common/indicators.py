...
class Indicators:
    ...
    def parse_stix2(self, file_path: str) -> None:
        ...
        """
        log_file_path = file_path.replace(
            "raw.githubusercontent.com_mvt-project_mvt-indicators_main_", ""
        )
        log_file_path = log_file_path.replace("raw.githubusercontent.com_", "")
        log_file_path = log_file_path.replace("modules/indicators/", "")

        self.log.info("Parsing STIX2 indicators file %s", log_file_path)

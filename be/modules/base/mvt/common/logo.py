...
def check_updates() -> None:
    ...
    try:
        ...
        if latest_version:
            rich_print(f"\t\t[bold](Latest Version)[/bold]")
            # rich_print(
...
def logo() -> None:
    rich_print("\n")
    rich_print(
        "\t[bold]CundamaniX[/bold] - Comprehensive Uncovering and Network Data Analysis for Mobile Assessment and Network Investigation eXpert"
    )
    rich_print("\t\thttps://s.id/cundamanix")

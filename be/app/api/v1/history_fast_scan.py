...
@router.get("/history_fast_scan/{serial_number}/{time_stamp}")
async def get_history_fast_scan(
    ...
    file_path = BASE_SCAN_PATH / "fast-scan" / serial_number / time_stamp / "detail_result.json"
